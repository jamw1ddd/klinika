...
from .views import doctor_admin, index,doctor_detail, login,services,service_detail,doctors,blog,blog_detail,contact,appointment,table,success,about,blog_search
